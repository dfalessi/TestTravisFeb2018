...
public class GUICalculator extends Application{
  ...
  button9, button0, buttondecimal, buttonplus, buttonminus, buttonmultiply, buttondivide, buttonequals;
  Double val1, val2;
  ...
  public void start(Stage stage) throws Exception{
    ...
    buttonequals.setOnAction(new EventHandler<ActionEvent>() {
      public void handle(ActionEvent event) {
        ...
        result.clear();
        calculated = ResCal.result;
        result.appendText(calculated.toString());
      }
    });
    ...
    column3.getChildren().addAll(button9, button6, button3, buttonequals);
    column4.getChildren().addAll(buttondivide, buttonmultiply, buttonminus, buttonplus);
    
    resultBox.getChildren().addAll(result);
    inputBox.getChildren().addAll(column1, column2, column3, column4);
    
    root.getChildren().addAll(resultBox, inputBox);
